    ...
    industrial: [
      {
        ...
        description:
          'LiboBerry is an AI-Powered scientific writing assistant service.',
        tasks: [
      ...
      {
        title:
          'React Developer at <a target="_blank" href="https://www.learnpersianart.com/">Rhythmitica</a>',
        ...
        tasks: [
          `Developed an online shop for music instruments.`,
          `Developed a WebApp for class reservation.`,
          `Developed a PWA for class management.`,
          `Developed a custom calendar component for managing classes.`,
          `Designed a UI for the online shop using.`,
          `Designed a UI for the class reservation website using.`,
          `Designed a UI for the PWA.`,
        ],
        tags: [
          'ReactJs',
          'React Hooks',
      ...
      {
        title:
          'Frontend Developer at <a target="_blank" href="https://ex-changelly.com/">Changelly</a>',
        companyName: 'Changelly',
        icon: 'assets/img/industrial/changelly.png',
        date: 'May 2020 - Jul 2020',
        description: 'Changelly is an online cryptocurrency shop.',
        tasks: [
          `Developed a HomePage.`,
          `Developed a custom chart library with SVG & JS.`,
        ],
        tags: ['JS', 'SVG', 'HTML', 'CSS'],
      },
      {
        title:
          'UI Designer at <a target="_blank" href="https://www.farazbal.com/">Farazbal</a>',
        companyName: 'Farazbal',
        icon: 'assets/img/industrial/farazbal.png',
        date: 'May 2019',
        description:
          'Farazbal is an online website which introduces the products.',
        tasks: [
          `Developed some components of the website.`,
          `Designed a UI for the website.`,
        ],
      ...
      },
      {
        ...
        description:
          'Satell is an online sales platform for connecting local shops and customers.',
        tasks: [
          `Developed a landing page.`,
          `Designed a UI for the website.`,
          `Designed Satell's Logo`,
        ],
      ...
      },
      {
        ...
        tasks: [
          `Designed and Developed an insurance panel with ReactJs.`,
          `Designed and Developed a Login Page with HTML, CSS, JS.`,
        ],
...
function getSkills() {
  ...
  return cv.skills
    .map(({ title, skills }) => getSkill(title, skills))
    .join('\n');
}

function getIndastrials() {
  function getIndustrial(
    title,
    companyName,
    icon,
    date,
...
function getCertificates() {
  ...
  return cv.certificates
    .map(({ title, icon, date, description, link }) =>
      getCertificate(title, icon, date, description, link)
    )
    .join('\n');
}
...
function getLanguages() {
  ...
  return cv.languages
    .map(({ title, amount }) => getLanguage(title, amount))
    .join('\n');
}
